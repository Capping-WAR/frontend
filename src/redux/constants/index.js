...
export const API_MIDDLEWARE_STATISTICS_ENDPOINT = 'statistics';
...
export const POST_REVIEWER_DONE = 'POST_REVIEWER_DONE';
...
export const POST_LOGIN_STATS_REQUEST = 'POST_LOGIN_STATS_REQUEST';
export const POST_LOGIN_STATS_SUCCESS = 'POST_LOGIN_STATS_SUCCESS';
export const POST_LOGIN_STATS_FAILURE = 'POST_LOGIN_STATS_FAILURE';

export const POST_USER_STATS_REQUEST = 'POST_USER_STATS_REQUEST';
export const POST_USER_STATS_SUCCESS = 'POST_USER_STATS_SUCCESS';
export const POST_USER_STATS_FAILURE = 'POST_USER_STATS_FAILURE';
...
export const DONE_FETCHING_USER_COUNT = 'DONE_FETCHING_USER_COUNT';

export const FETCH_USERS_BY_OS_REQUEST = 'FETCH_USERS_BY_OS_REQUEST';
export const FETCH_USERS_BY_OS_SUCCESS = 'FETCH_USERS_BY_OS_SUCCESS';
export const FETCH_USERS_BY_OS_FAILURE = 'FETCH_USERS_BY_OS_FAILURE';
export const DONE_FETCHING_USERS_BY_OS = 'DONE_FETCHING_USERS_BY_OS';

export const FETCH_LOGIN_STATS_REQUEST = 'FETCH_LOGIN_STATS_REQUEST';
export const FETCH_LOGIN_STATS_SUCCESS = 'FETCH_LOGIN_STATS_SUCCESS';
export const FETCH_LOGIN_STATS_FAILURE = 'FETCH_LOGIN_STATS_FAILURE';
export const DONE_FETCHING_LOGIN_STATS = 'DONE_FETCHING_LOGIN_STATS';
